...
df_AG_real_age.groupby("Age").mean()
...
lr_AG_age_per_class_acc_distrib = pd.melt(
    lr_AG_age_per_class_acc_distrib, var_name="AG age")
lr_AG_age_per_class_acc_distrib
plt.figure(figsize=(4.75, 3))
plt.rc('font', family='Helvetica')
sns.violinplot(x="AG age", y="value", cut=0, 
               order=list(lr_AG_age_per_class_acc_distrib["AG age"].unique()),
