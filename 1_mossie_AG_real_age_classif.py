...
plt.figure()
ax = sns.distplot(df_test_intervention.index, bins=len(df_test_intervention.index.unique()), label="True age")
...
#%% Predict age structure of population with missing ages only
plt.figure()
