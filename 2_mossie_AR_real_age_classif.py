...
df_ar_real_age = df_real_age_elim[df_real_age_elim["Species"] == "AR"]
# df_ar_real_age_missing = df_real_age_missing[df_real_age_missing["Species"] == "AG"]
Counter(df_ar_real_age.columns)

# feed
df_ar_all = df_ar_real_age.iloc[:, 4:]
df_ar_BF = df_ar_real_age[df_ar_real_age["Status"] == "BF"].iloc[:, 4:]
df_ar_SF = df_ar_real_age[df_ar_real_age["Status"] == "SF"].iloc[:, 4:]
df_ar_GR = df_ar_real_age[df_ar_real_age["Status"] == "GR"].iloc[:, 4:]
df_ar_SF_GR = df_ar_real_age[(df_ar_real_age["Status"] == "GR") | ( df_ar_real_age["Status"] == "SF")].iloc[:, 4:]

# df_ar_SF_GR.to_csv('/Users/s_a_b/Documents/@wip/presentations & meetings/Ifakara workshop/presentation/workshop/df_age_arabiensis.csv')

# df_ar_all_missing = df_ar_real_age_missing.iloc[:,4:]
# df_ar_SF_GR_missing = df_ar_real_age_missing[(df_ar_real_age_missing["Status"] == "GR") | ( df_ar_real_age_missing["Status"] == "SF")].iloc[:, 4:]

# transform species data
for df in [df_ar_all, df_ar_SF, df_ar_SF, df_ar_GR, df_ar_SF_GR]:
...
plt.savefig("./plots/spot_check_ar_real_age_SF_GR.pdf", bbox_inches="tight")
plt.savefig("./plots/spot_check_ar_real_age_SF_GR.png", bbox_inches="tight")
...
# df_source_missing = df_ar_SF_GR_missing.reset_index()
...
for age in df_source["Real age"].unique():
    ...
    natural_survival = df_source[df_source["Real age"] == age].sample(
        n=3 * fraction_nat, random_state=seed)
    ...
    intervention_survival = df_source[df_source["Real age"] == age].sample(
        n=3 * fraction_int, random_state=seed)
...
# Results
rskf_results.to_csv(
    "./results/lr_ar_age_repeatedCV_record_SF_GR.csv", index=False)
...
rkf_scores.dropna(axis=1).to_csv(
    "./results/lr_ar_age_rkf_scores_SF.csv", index=False)

#%% plots
rskf_results = pd.read_csv("./results/lr_ar_age_repeatedCV_record_SF_GR.csv")
rkf_scores = pd.read_csv("./results/lr_ar_age_rkf_scores_SF.csv")
# rkf_scores.index = y.unique().zfill(1)


# Accuracy distribution
lr_ar_age_acc_distrib = rskf_results["Accuracy"]
lr_ar_age_acc_distrib.columns = ["Accuracy"]
lr_ar_age_acc_distrib.to_csv(
    "./results/lr_ar_age_acc_distrib_SF_GR.csv", header=True, index=False)
lr_ar_age_acc_distrib = pd.read_csv(
    "./results/lr_ar_age_acc_distrib_SF_GR.csv")
lr_ar_age_acc_distrib = np.round(100 * lr_ar_age_acc_distrib)

plt.figure(figsize=(2.25, 3))
sns.distplot(lr_ar_age_acc_distrib, kde=False, bins=12)
plt.savefig("./plots/lr_ar_age_acc_distrib_SF_GR.pdf", bbox_inches="tight")
plt.savefig("./plots/lr_ar_age_acc_distrib_SF_GR.png", bbox_inches="tight")

# Per class accuracy
class_names = y.sort_values().unique()
lr_ar_age_per_class_acc_distrib = pd.DataFrame(
    rskf_per_class_results, columns=class_names)
lr_ar_age_per_class_acc_distrib.dropna().to_csv(
    "./results/lr_ar_age_per_class_acc_distrib_SF_GR.csv")
lr_ar_age_per_class_acc_distrib = pd.read_csv(
    "./results/lr_ar_age_per_class_acc_distrib_SF_GR.csv", index_col=0)
lr_ar_age_per_class_acc_distrib = np.round(
    100 * lr_ar_age_per_class_acc_distrib)
lr_ar_age_per_class_acc_distrib_describe = lr_ar_age_per_class_acc_distrib.describe()
lr_ar_age_per_class_acc_distrib_describe.to_csv(
    "./results/lr_ar_age_per_class_acc_distrib_SF_GR.csv")

lr_ar_age_per_class_acc_distrib = pd.melt(
    lr_ar_age_per_class_acc_distrib, var_name="AR age")
lr_ar_age_per_class_acc_distrib
plt.figure(figsize=(4.75, 3))
plt.rc('font', family='Helvetica')
sns.violinplot(x="AR age", y="value", cut=0,
               order=list(lr_ar_age_per_class_acc_distrib["AR age"].unique()),
               data=lr_ar_age_per_class_acc_distrib)
sns.despine(left=True)
plt.xticks(rotation=0, ha="right")
plt.xlabel("Anopheles arabiensis age")
plt.ylabel("Prediction accuracy")
plt.savefig("./plots/lr_ar_age_per_class_acc_distrib_SF_GR.pdf",
            bbox_inches="tight")
plt.savefig("./plots/lr_ar_age_per_class_acc_distrib_SF_GR.png",
            bbox_inches="tight")
...
plt.savefig("./plots/lr_ar_age_cm_SF_GR.pdf", bbox_inches="tight")
plt.savefig("./plots/lr_ar_age_cm_SF_GR.png", bbox_inches="tight")
...
# plt.savefig("./plots/lr_ar_age_struct_cm.pdf", bbox_inches="tight")
...
# plt.legend()
# plt.savefig("./plots/lr_ar_age_struct_missing_SF_GR.pdf", bbox_inches="tight")
# plt.savefig("./plots/lr_ar_age_struct_missing_SF_GR.png", bbox_inches="tight")
...
# df_source_missing = df_ar_all_missing.reset_index()
# df_test_missing = pd.DataFrame()

for age in df_source["Real age"].unique():
    fraction_nat = int(age_prop.iloc[age, 1]*len(df.index[df.index == 1]))
    natural_survival = df_source[df_source["Real age"] == age].sample(n=2*fraction_nat, random_state=seed)
    df_test = df_test.append(natural_survival)

    fraction_int = int(age_prop.iloc[age, 3]*len(df.index[df.index == 1]))
...
# Results
rskf_results.to_csv("./results/lr_ar_age_repeatedCV_record.csv", index=False)
...
rkf_scores.dropna(axis=1).to_csv(
    "./results/lr_ar_age_rkf_scores.csv", index=False)

rskf_results = pd.read_csv("./results/lr_ar_age_repeatedCV_record.csv")
rkf_scores = pd.read_csv("./results/lr_ar_age_rkf_scores.csv")
# rkf_scores.index = y.unique().zfill(1)
...
lr_ar_age_acc_distrib.columns = ["Accuracy"]
lr_ar_age_acc_distrib.to_csv(
    "./results/lr_ar_age_acc_distrib.csv", header=True, index=False)
lr_ar_age_acc_distrib = pd.read_csv("./results/lr_ar_age_acc_distrib.csv")
lr_ar_age_acc_distrib = np.round(100 * lr_ar_age_acc_distrib)

plt.figure(figsize=(2.25, 3))
sns.distplot(lr_ar_age_acc_distrib, kde=False, bins=12)
plt.savefig("./plots/lr_ar_age_acc_distrib.pdf", bbox_inches="tight")
plt.savefig("./plots/lr_ar_age_acc_distrib.png", bbox_inches="tight")
...
lr_ar_age_per_class_acc_distrib = pd.DataFrame(
    rskf_per_class_results, columns=class_names)
lr_ar_age_per_class_acc_distrib.dropna().to_csv(
    "./results/lr_ar_age_per_class_acc_distrib.csv")
lr_ar_age_per_class_acc_distrib = pd.read_csv(
    "./results/lr_ar_age_per_class_acc_distrib.csv", index_col=0)
lr_ar_age_per_class_acc_distrib = np.round(
    100 * lr_ar_age_per_class_acc_distrib)
lr_ar_age_per_class_acc_distrib_describe = lr_ar_age_per_class_acc_distrib.describe()
lr_ar_age_per_class_acc_distrib_describe.to_csv(
...
plt.ylabel("Prediction accuracy")
plt.savefig("./plots/lr_ar_age_per_class_acc_distrib.pdf", bbox_inches="tight")
plt.savefig("./plots/lr_ar_age_per_class_acc_distrib.png", bbox_inches="tight")
...
plt.figure(figsize=(4, 4))
plot_confusion_matrix(best_n_cm, normalise=True, classes=class_names)
plt.savefig("./plots/lr_ar_age_cm.pdf", bbox_inches="tight")
plt.savefig("./plots/lr_ar_age_cm.png", bbox_inches="tight")
...
plt.legend()
plt.savefig("./plots/lr_ar_age_struct.pdf", bbox_inches = "tight")
plt.savefig("./plots/lr_ar_age_struct.png", bbox_inches = "tight")
...
plt.legend()
plt.savefig("./plots/lr_ar_age_struct_int.pdf", bbox_inches="tight")
plt.savefig("./plots/lr_ar_age_struct_int.png", bbox_inches="tight")
...
arrow = plt.arrow(x=4, y=0.25, dx=0, dy=-0.05, width=0.25, head_length=0.03, color="k", label="Intervention")
plt.legend()
plt.savefig("./plots/lr_ar_age_struct_missing.pdf", bbox_inches="tight")
plt.savefig("./plots/lr_ar_age_struct_missing.png", bbox_inches="tight")
...
for train_index, test_index in rskf.split(X, y):
    ...
    y_pred = best_model.predict(
        np.delete(X, train_index, axis=0))
    y_predproba = best_model.predict_proba(np.delete(X, train_index, axis=0))
    y_test = np.delete(y, train_index, axis=0)
    local_cm = confusion_matrix(y_test, y_pred)
    local_report = classification_report(y_test, y_pred)
    ...
    local_rskf_results = pd.DataFrame([("Accuracy", accuracy_score(y_test, y_pred)), ("params", str(rsCV_result.best_params_)), ("seed", best_model.seed), ("TRAIN", str(
        train_index)), ("TEST", str(test_index)), ("Pickle", pickle.dumps(best_model)), ("Pred_probas", y_predproba), ("CM", local_cm), ("Classification report", local_report), ("Feature importances", local_feat_impces.to_dict())]).T
...
# Results
rskf_results.to_csv("./results/xgb_ar_repeatedCV_record.csv", index=False)
rskf_results = pd.read_csv("./results/xgb_ar_repeatedCV_record.csv")


# Accuracy distribution
xgb_ar_acc_distrib = rskf_results["Accuracy"]
xgb_ar_acc_distrib.columns = ["Accuracy"]
xgb_ar_acc_distrib.to_csv(
    "./results/xgb_ar_acc_distrib.csv", header=True, index=False)
xgb_ar_acc_distrib = pd.read_csv("./results/xgb_ar_acc_distrib.csv")
xgb_ar_acc_distrib = np.round(100 * xgb_ar_acc_distrib)

plt.figure(figsize=(2.25, 3))
sns.distplot(xgb_ar_acc_distrib, kde=False, bins=12)
plt.savefig("./plots/xgb_ar_acc_distrib.pdf", bbox_inches="tight")
plt.savefig("./plots/xgb_ar_acc_distrib.png", bbox_inches="tight")

class_names = y.sort_values().unique()
xgb_ar_per_class_acc_distrib = pd.DataFrame(
    rskf_per_class_results, columns=class_names)
xgb_ar_per_class_acc_distrib.dropna().to_csv(
    "./results/xgb_ar_per_class_acc_distrib.csv")
xgb_ar_per_class_acc_distrib = pd.read_csv(
    "./results/xgb_ar_per_class_acc_distrib.csv", index_col=0)
xgb_ar_per_class_acc_distrib = np.round(100 * xgb_ar_per_class_acc_distrib)
xgb_ar_per_class_acc_distrib_describe = xgb_ar_per_class_acc_distrib.describe()
xgb_ar_per_class_acc_distrib_describe.to_csv(
    "./results/xgb_ar_per_class_acc_distrib.csv")

xgb_ar_per_class_acc_distrib = pd.melt(
    xgb_ar_per_class_acc_distrib, var_name="AR age")

plt.figure(figsize=(4.75, 3))
plt.rc('font', family='Helvetica')
sns.violinplot(x="AR age", y="value", cut=0,
               order=list(xgb_ar_per_class_acc_distrib["AR age"].unique()),
               data=xgb_ar_per_class_acc_distrib)
sns.despine(left=True)
# plt.xticks(rotation=45, ha="right")
plt.xlabel("Anopheles arabiensis age")
plt.ylabel("Prediction accuracy\n ({0:.2f} ± {1:.2f})".format(
    xgb_ar_per_class_acc_distrib["value"].mean(), xgb_ar_per_class_acc_distrib["value"].sem()), weight="bold")
plt.savefig("./plots/xgb_ar_per_class_acc_distrib.pdf", bbox_inches="tight")
plt.savefig("./plots/xgb_ar_per_class_acc_distrib.png", bbox_inches="tight")
...
plt.savefig("./plots/xgb_ar_feat_imp.pdf", bbox_inches="tight")
plt.savefig("./plots/xgb_ar_feat_imp.png", bbox_inches="tight")
...
plt.figure(figsize=(4, 4))
plot_confusion_matrix(best_n_cm, normalise=True, classes=class_names)
plt.savefig("./plots/xgb_ar_age_cm.pdf", bbox_inches="tight")
plt.savefig("./plots/xgb_ar_age_cm.png", bbox_inches="tight")
...
# age_prop_cm = confusion_matrix(list(df_test.index), best_clf.predict(df_test))
# class_names = df_test.index.sort_values().unique()
# plt.savefig("./plots/xgb_ar_age_struct_cm.pdf", bbox_inches="tight")
# plt.savefig("./plots/xgb_ar_age_struct_cm.png", bbox_inches="tight"
...
ax.set(xlim=(0, 25), xlabel="Mosquito age", ylabel="Proportion in population")
plt.legend()
plt.savefig("./plots/xgb_ar_age_struct.pdf", bbox_inches="tight")
plt.savefig("./plots/xgb_ar_age_struct.png", bbox_inches="tight")

# Predict and reconstruct age structure of population post intervention
plt.figure()
ax = sns.distplot(df_test_intervention.index, bins=len(df_test_intervention.index.unique(
)), label="True age", kde=False, fit=stats.halflogistic, fit_kws={"cut": 1, "color": "b", "lw": 3})
ax = sns.distplot(age_prop_int_pred, bins=len(
    df_test_intervention.index.unique()), color="r", label="Predicted age", kde=False, fit=stats.halflogistic, fit_kws={"cut": 1, "color": "r", "lw": 3})
ax.set(xlim=(0, 25), xlabel="Mosquito age", ylabel="Proportion in population")
arrow = plt.arrow(x=4, y=0.4, dx=0, dy=-0.1, width=0.25,
                  head_length=0.03, color="k", label="Intervention")
plt.legend()
plt.savefig("./plots/xgb_ar_age_struct_int.pdf", bbox_inches="tight")
plt.savefig("./plots/xgb_ar_age_struct_int.png", bbox_inches="tight")
...
plt.savefig("./plots/spot_check_ar_real_age_GR.pdf", bbox_inches="tight")
plt.savefig("./plots/spot_check_ar_real_age_GR.png", bbox_inches="tight")
...
# Results
rskf_results.to_csv(
    "./results/lr_ar_age_repeatedCV_record_GR.csv", index=False)
...
rkf_scores.dropna(axis=1).to_csv(
    "./results/lr_ar_age_rkf_scores_GR.csv", index=False)

rskf_results = pd.read_csv("./results/lr_ar_age_repeatedCV_record_GR.csv")
rkf_scores = pd.read_csv("./results/lr_ar_age_rkf_scores_GR.csv")
# rkf_scores.index = y.unique().zfill(1)
...
lr_ar_age_acc_distrib.columns = ["Accuracy"]
lr_ar_age_acc_distrib.to_csv(
    "./results/lr_ar_age_acc_distrib_GR.csv", header=True, index=False)
lr_ar_age_acc_distrib = pd.read_csv("./results/lr_ar_age_acc_distrib_GR.csv")
lr_ar_age_acc_distrib = np.round(100 * lr_ar_age_acc_distrib)

plt.figure(figsize=(2.25, 3))
sns.distplot(lr_ar_age_acc_distrib, kde=False, bins=12)
plt.savefig("./plots/lr_ar_age_acc_distrib_GR.pdf", bbox_inches="tight")
plt.savefig("./plots/lr_ar_age_acc_distrib_GR.png", bbox_inches="tight")
...
lr_ar_age_per_class_acc_distrib = pd.DataFrame(
    rskf_per_class_results, columns=class_names)
lr_ar_age_per_class_acc_distrib.dropna().to_csv(
    "./results/lr_ar_age_per_class_acc_distrib_GR.csv")
lr_ar_age_per_class_acc_distrib = pd.read_csv(
    "./results/lr_ar_age_per_class_acc_distrib_GR.csv", index_col=0)
lr_ar_age_per_class_acc_distrib = np.round(
    100 * lr_ar_age_per_class_acc_distrib)
lr_ar_age_per_class_acc_distrib_describe = lr_ar_age_per_class_acc_distrib.describe()
lr_ar_age_per_class_acc_distrib_describe.to_csv(
...
plt.xlabel("Anopheles arabiensis age")
plt.ylabel("Prediction accuracy")
plt.savefig("./plots/lr_ar_age_per_class_acc_distrib_GR.pdf",
            bbox_inches="tight")
plt.savefig("./plots/lr_ar_age_per_class_acc_distrib_GR.png",
            bbox_inches="tight")
...
plt.savefig("./plots/lr_ar_age_cm_GR.pdf", bbox_inches="tight")
plt.savefig("./plots/lr_ar_age_cm_GR.png", bbox_inches="tight")
...
plt.savefig("./plots/spot_check_ar_real_age_BF.pdf", bbox_inches="tight")
plt.savefig("./plots/spot_check_ar_real_age_BF.png", bbox_inches="tight")
...
# Results
rskf_results.to_csv(
    "./results/lr_ar_age_repeatedCV_record_BF.csv", index=False)
...
rkf_scores.dropna(axis=1).to_csv(
    "./results/lr_ar_age_rkf_scores_BF.csv", index=False)

rskf_results = pd.read_csv("./results/lr_ar_age_repeatedCV_record_BF.csv")
rkf_scores = pd.read_csv("./results/lr_ar_age_rkf_scores_BF.csv")
# rkf_scores.index = y.unique().zfill(1)
...
lr_ar_age_acc_distrib.columns = ["Accuracy"]
lr_ar_age_acc_distrib.to_csv(
    "./results/lr_ar_age_acc_distrib_BF.csv", header=True, index=False)
lr_ar_age_acc_distrib = pd.read_csv("./results/lr_ar_age_acc_distrib_BF.csv")
lr_ar_age_acc_distrib = np.round(100 * lr_ar_age_acc_distrib)

plt.figure(figsize=(2.25, 3))
sns.distplot(lr_ar_age_acc_distrib, kde=False, bins=12)
plt.savefig("./plots/lr_ar_age_acc_distrib_BF.pdf", bbox_inches="tight")
plt.savefig("./plots/lr_ar_age_acc_distrib_BF.png", bbox_inches="tight")
...
lr_ar_age_per_class_acc_distrib = pd.DataFrame(
    rskf_per_class_results, columns=class_names)
lr_ar_age_per_class_acc_distrib.dropna().to_csv(
    "./results/lr_ar_age_per_class_acc_distrib_BF.csv")
lr_ar_age_per_class_acc_distrib = pd.read_csv(
    "./results/lr_ar_age_per_class_acc_distrib_BF.csv", index_col=0)
lr_ar_age_per_class_acc_distrib = np.round(
    100 * lr_ar_age_per_class_acc_distrib)
lr_ar_age_per_class_acc_distrib_describe = lr_ar_age_per_class_acc_distrib.describe()
lr_ar_age_per_class_acc_distrib_describe.to_csv(
...
plt.xlabel("Anopheles arabiensis age")
plt.ylabel("Prediction accuracy")
plt.savefig("./plots/lr_ar_age_per_class_acc_distrib_BF.pdf",
            bbox_inches="tight")
plt.savefig("./plots/lr_ar_age_per_class_acc_distrib_BF.png",
            bbox_inches="tight")
...
plt.figure(figsize=(4, 4))
plot_confusion_matrix(best_cm, classes=class_names)
plt.savefig("./plots/lr_ar_age_cm_BF.pdf", bbox_inches="tight")
plt.savefig("./plots/lr_ar_age_cm_BF.png", bbox_inches="tight")
