...
df_ar_food = df_full.copy()
df_ar_food.index = df_ar_food["Real age"]
df_ar_SF = df_ar_food[df_ar_food["Status"] == "SF"].iloc[:, 5:]
df_ar_SF = df_ar_food[df_ar_food["Status"] == "SF"].iloc[:, 5:]
df_ar_GR = df_ar_food[df_ar_food["Status"] == "GR"].iloc[:, 5:]

# transform species data
for df in [df_ar_SF, df_ar_SF, df_ar_GR]:
...
for round in range(num_rounds):
    ...
    for train_index, test_index in rskf.split(X, y):
        ...
        y_predproba = classifier.predict_proba(np.delete(X, train_index, axis=0))
...
best_cm = rskf_results.sort_values(by="Accuracy", ascending=False).iloc[0, 4].replace('[ ','[').split()
...
# Results
rskf_results.to_csv("./results/lr_ar_age_repeatedCV_record_BF.csv", index=False)
...
plt.xlabel("Anopheles arabiensis age")
plt.ylabel("Prediction accuracy")
plt.savefig("./plots/lr_ar_age_per_class_acc_distrib_BF.pdf", bbox_inches="tight")
plt.savefig("./plots/lr_ar_age_per_class_acc_distrib_BF.png", bbox_inches="tight")
...
plt.savefig("./plots/spot_check_ar_real_age_SF.pdf", bbox_inches="tight")
plt.savefig("./plots/spot_check_ar_real_age_SF.png", bbox_inches="tight")
...
# Results
rskf_results.to_csv(
    "./results/lr_ar_age_repeatedCV_record_SF.csv", index=False)
...
rskf_results = pd.read_csv("./results/lr_ar_age_repeatedCV_record_SF.csv")
...
lr_ar_age_acc_distrib.columns = ["Accuracy"]
lr_ar_age_acc_distrib.to_csv(
    "./results/lr_ar_age_acc_distrib_SF.csv", header=True, index=False)
lr_ar_age_acc_distrib = pd.read_csv("./results/lr_ar_age_acc_distrib_SF.csv")
lr_ar_age_acc_distrib = np.round(100 * lr_ar_age_acc_distrib)

plt.figure(figsize=(2.25, 3))
sns.distplot(lr_ar_age_acc_distrib, kde=False, bins=12)
plt.savefig("./plots/lr_ar_age_acc_distrib_SF.pdf", bbox_inches="tight")
plt.savefig("./plots/lr_ar_age_acc_distrib_SF.png", bbox_inches="tight")
...
lr_ar_age_per_class_acc_distrib = pd.DataFrame(
    rskf_per_class_results, columns=class_names)
lr_ar_age_per_class_acc_distrib.dropna().to_csv(
    "./results/lr_ar_age_per_class_acc_distrib_SF.csv")
lr_ar_age_per_class_acc_distrib = pd.read_csv(
    "./results/lr_ar_age_per_class_acc_distrib_SF.csv", index_col=0)
lr_ar_age_per_class_acc_distrib = np.round(
    100 * lr_ar_age_per_class_acc_distrib)
lr_ar_age_per_class_acc_distrib_describe = lr_ar_age_per_class_acc_distrib.describe()
lr_ar_age_per_class_acc_distrib_describe.to_csv(
...
plt.xlabel("Anopheles arabiensis age")
plt.ylabel("Prediction accuracy")
plt.savefig("./plots/lr_ar_age_per_class_acc_distrib_SF.pdf",
            bbox_inches="tight")
plt.savefig("./plots/lr_ar_age_per_class_acc_distrib_SF.png",
            bbox_inches="tight")
...
plt.figure(figsize=(4, 4))
plot_confusion_matrix(best_cm, classes=class_names)
plt.savefig("./plots/lr_ar_age_cm_SF.pdf", bbox_inches="tight")
plt.savefig("./plots/lr_ar_age_cm_SF.png", bbox_inches="tight")
